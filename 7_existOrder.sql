...
where isim is null;
 ...
 select * from insanlar;
-- tabloyu eski haline donduryoruz
...
-- 10. veriden 2 veriyi al (11-12)  
select * from kisiler limit 10,2; -- ilk sayi dahil degil 11'den basla 2.inci sayi kadar git (2 tane git)
select * from kisiler where id> 10 limit 2; -- 2. yol
...
-- select * from kisiler 
-- order by maas desc 
-- fetch next 3 rows only  ORACLE COZUMU!!!
